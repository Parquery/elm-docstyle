...
var _Parquery$elm_docstyle$Check$commentText = function (comment) {
	return function (com) {
		return A2(_elm_lang$core$String$endsWith, '-}', com) ? A2(_elm_lang$core$String$dropRight, 2, com) : com;
	}(
		A2(_elm_lang$core$String$startsWith, '{-|', comment) ? A2(_elm_lang$core$String$dropLeft, 3, comment) : (A2(_elm_lang$core$String$startsWith, '{-', comment) ? A2(_elm_lang$core$String$dropLeft, 2, comment) : (A2(_elm_lang$core$String$startsWith, '--', comment) ? A2(_elm_lang$core$String$dropLeft, 2, comment) : comment)));
};
var _Parquery$elm_docstyle$Check$NotAnnotatedArgument = function (a) {
	return {ctor: 'NotAnnotatedArgument', _0: a};
};
var _Parquery$elm_docstyle$Check$notAnnotatedArgument = F2(
	function (parsedArguments, shouldBeAnnotated) {
		return A2(_elm_lang$core$List$member, shouldBeAnnotated, parsedArguments) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(
			_Parquery$elm_docstyle$Check$NotAnnotatedArgument(shouldBeAnnotated));
	});
var _Parquery$elm_docstyle$Check$NotExistingArgument = function (a) {
	return {ctor: 'NotExistingArgument', _0: a};
};
var _Parquery$elm_docstyle$Check$notExistingArgument = F2(
	function (parsedArguments, allowed) {
		return A2(
			_elm_lang$core$List$map,
			_Parquery$elm_docstyle$Check$NotExistingArgument,
			A2(
				_elm_lang$core$List$filter,
				function (el) {
					return !A2(_elm_lang$core$List$member, el, allowed);
				},
				parsedArguments));
	});
var _Parquery$elm_docstyle$Check$NoTopLevelComment = {ctor: 'NoTopLevelComment'};
var _Parquery$elm_docstyle$Check$NoEntityComment = {ctor: 'NoEntityComment'};
var _Parquery$elm_docstyle$Check$TodoComment = {ctor: 'TodoComment'};
var _Parquery$elm_docstyle$Check$todoComment = function (comment) {
	return function (str) {
		return (A2(_elm_lang$core$String$contains, 'todo', str) || A2(_elm_lang$core$String$contains, 'fixme', str)) ? _elm_lang$core$Maybe$Just(_Parquery$elm_docstyle$Check$TodoComment) : _elm_lang$core$Maybe$Nothing;
	}(
		_elm_lang$core$String$toLower(comment));
};
var _Parquery$elm_docstyle$Check$WrongCommentType = {ctor: 'WrongCommentType'};
var _Parquery$elm_docstyle$Check$commentType = function (comment) {
	return A2(_elm_lang$core$String$startsWith, '{-|', comment) ? _elm_lang$core$Maybe$Just(_Parquery$elm_docstyle$Check$WrongCommentType) : _elm_lang$core$Maybe$Nothing;
};
var _Parquery$elm_docstyle$Check$EmptyComment = {ctor: 'EmptyComment'};
var _Parquery$elm_docstyle$Check$emptyComment = function (comment) {
	return function (words) {
		return A2(
			_elm_lang$core$List$any,
			function (word) {
				return !_elm_lang$core$Native_Utils.eq(
					_elm_lang$core$String$trim(word),
					'');
			},
			words) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_Parquery$elm_docstyle$Check$EmptyComment);
	}(
		_elm_lang$core$String$words(
			_Parquery$elm_docstyle$Check$commentText(comment)));
};
var _Parquery$elm_docstyle$Check$NoEndingPeriod = {ctor: 'NoEndingPeriod'};
var _Parquery$elm_docstyle$Check$endingPeriod = function (comment) {
	var last = A2(
		_elm_lang$core$String$right,
		1,
		_elm_lang$core$String$trim(
			_Parquery$elm_docstyle$Check$commentText(comment)));
	return (_elm_lang$core$Native_Utils.eq(last, '.') || _elm_lang$core$Native_Utils.eq(last, '')) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_Parquery$elm_docstyle$Check$NoEndingPeriod);
};
var _Parquery$elm_docstyle$Check$NoStartingVerb = {ctor: 'NoStartingVerb'};
var _Parquery$elm_docstyle$Check$startingVerb = function (comment) {
	var firstWord = A2(
		...
		_elm_lang$core$List$head(
			_elm_lang$core$String$words(
				_Parquery$elm_docstyle$Check$commentText(comment))));
	return A2(_elm_lang$core$String$endsWith, 's', firstWord) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_Parquery$elm_docstyle$Check$NoStartingVerb);
};
var _Parquery$elm_docstyle$Check$NoStartingSpace = {ctor: 'NoStartingSpace'};
var _Parquery$elm_docstyle$Check$startingSpace = function (comment) {
	return function (text) {
		return (_elm_lang$core$Native_Utils.eq(
			_elm_lang$core$String$trim(text),
			'') || A2(_elm_lang$core$String$startsWith, ' ', text)) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_Parquery$elm_docstyle$Check$NoStartingSpace);
	}(
		_Parquery$elm_docstyle$Check$commentText(comment));
};
var _Parquery$elm_docstyle$Check$NotCapitalized = {ctor: 'NotCapitalized'};
var _Parquery$elm_docstyle$Check$startingCapitalized = function (comment) {
	var first = A2(
		_elm_lang$core$Maybe$withDefault,
		'A',
		_elm_lang$core$List$head(
...
var _Parquery$elm_docstyle$Check$stringToViolation = function (str) {
	var _p0 = str;
	switch (_p0) {
		case 'NoStartingSpace':
			return _elm_lang$core$Maybe$Just(_Parquery$elm_docstyle$Check$NoStartingSpace);
		case 'NotCapitalized':
			return _elm_lang$core$Maybe$Just(_Parquery$elm_docstyle$Check$NotCapitalized);
		case 'NoStartingVerb':
			return _elm_lang$core$Maybe$Just(_Parquery$elm_docstyle$Check$NoStartingVerb);
		case 'NoEndingPeriod':
			return _elm_lang$core$Maybe$Just(_Parquery$elm_docstyle$Check$NoEndingPeriod);
		case 'EmptyComment':
			return _elm_lang$core$Maybe$Just(_Parquery$elm_docstyle$Check$EmptyComment);
		case 'WrongCommentType':
			return _elm_lang$core$Maybe$Just(_Parquery$elm_docstyle$Check$WrongCommentType);
		case 'TodoComment':
			return _elm_lang$core$Maybe$Just(_Parquery$elm_docstyle$Check$TodoComment);
		case 'NoEntityComment':
			return _elm_lang$core$Maybe$Just(_Parquery$elm_docstyle$Check$NoEntityComment);
		case 'NoTopLevelComment':
			return _elm_lang$core$Maybe$Just(_Parquery$elm_docstyle$Check$NoTopLevelComment);
		case 'NotExistingArgument':
			return _elm_lang$core$Maybe$Just(
				_Parquery$elm_docstyle$Check$NotExistingArgument(''));
		case 'NotAnnotatedArgument':
			return _elm_lang$core$Maybe$Just(
				_Parquery$elm_docstyle$Check$NotAnnotatedArgument(''));
		default:
			return _elm_lang$core$Maybe$Nothing;
	}
};
...
var _Parquery$elm_docstyle$Models$Entity = F5(
	function (a, b, c, d, e) {
		return {range: a, eType: b, name: c, comment: d, exposed: e};
	});
var _Parquery$elm_docstyle$Models$ParsedModule = F4(
	function (a, b, c, d) {
		return {entities: a, moduleName: b, topLevelComment: c, otherComments: d};
	});
var _Parquery$elm_docstyle$Models$Flags = F4(
	function (a, b, c, d) {
		return {verbose: a, format: b, excludedChecks: c, checkAllDefinitions: d};
	});
var _Parquery$elm_docstyle$Models$TypeAlias = {ctor: 'TypeAlias'};
var _Parquery$elm_docstyle$Models$TypeDef = {ctor: 'TypeDef'};
var _Parquery$elm_docstyle$Models$Record = function (a) {
	return {ctor: 'Record', _0: a};
};
var _Parquery$elm_docstyle$Models$Function = function (a) {
	return {ctor: 'Function', _0: a};
};

var _Parquery$elm_docstyle$Configuration$Model = F4(
	function (a, b, c, d) {
		return {excludedChecks: a, checkAllDefinitions: b, verbose: c, format: d};
	});
var _Parquery$elm_docstyle$Configuration$HUMAN = {ctor: 'HUMAN'};
var _Parquery$elm_docstyle$Configuration$defaultFormat = _Parquery$elm_docstyle$Configuration$HUMAN;
var _Parquery$elm_docstyle$Configuration$defaultModel = {
	excludedChecks: {ctor: '[]'},
	checkAllDefinitions: false,
	verbose: false,
	format: _Parquery$elm_docstyle$Configuration$defaultFormat
};
var _Parquery$elm_docstyle$Configuration$JSON = {ctor: 'JSON'};
var _Parquery$elm_docstyle$Configuration$fromFlags = function (_p0) {
	var _p1 = _p0;
	var _p6 = _p1.format;
	var parsedFormat = (_elm_lang$core$Native_Utils.eq(_p6, '') || _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$String$toLower(_p6),
		'human')) ? _elm_lang$core$Result$Ok(_Parquery$elm_docstyle$Configuration$HUMAN) : (_elm_lang$core$Native_Utils.eq(
		_elm_lang$core$String$toLower(_p6),
		'json') ? _elm_lang$core$Result$Ok(_Parquery$elm_docstyle$Configuration$JSON) : _elm_lang$core$Result$Err(
		A2(
			_elm_lang$core$Basics_ops['++'],
			...
			A2(
				...
				A2(_elm_lang$core$Basics_ops['++'], ', got: ', _p6)))));
	var parsedChecks = function (list) {
		var _p4 = A2(
			_elm_lang$core$List$filter,
			function (_p2) {
				var _p3 = _p2;
				...
				return _elm_lang$core$Result$Err(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							'\"',
							A2(_elm_lang$core$Basics_ops['++'], errs, '\".'))));
			}(
				A2(
		...
		A2(
			...
			function (s) {
				return {
					ctor: '_Tuple2',
					_0: s,
					_1: _Parquery$elm_docstyle$Check$stringToViolation(s)
				};
			},
			_p1.excludedChecks));
	var _p5 = parsedFormat;
	if (_p5.ctor === 'Ok') {
		return A2(
			_elm_lang$core$Result$map,
			function (checks) {
				return {excludedChecks: checks, checkAllDefinitions: _p1.checkAllDefinitions, verbose: _p1.verbose, format: _p5._0};
			},
			parsedChecks);
	} else {
...
var _Parquery$elm_docstyle$Issue$unwrap = function (_p0) {
	var _p1 = _p0;
	return {ctor: '_Tuple2', _0: _p1._0.violated, _1: _p1._0.underlying};
};
var _Parquery$elm_docstyle$Issue$TopLevel = function (a) {
	return {ctor: 'TopLevel', _0: a};
};
var _Parquery$elm_docstyle$Issue$Dangling = function (a) {
	return {ctor: 'Dangling', _0: a};
};
var _Parquery$elm_docstyle$Issue$Entity = function (a) {
	return {ctor: 'Entity', _0: a};
};
var _Parquery$elm_docstyle$Issue$Issue = function (a) {
	return {ctor: 'Issue', _0: a};
};
var _Parquery$elm_docstyle$Issue$fromViolationsAndTrigger = F2(
	function (violated, underlying) {
		var _p2 = violated;
		if (_p2.ctor === '[]') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			return _elm_lang$core$Maybe$Just(
				_Parquery$elm_docstyle$Issue$Issue(
					{violated: violated, underlying: underlying}));
		}
	});

var _Parquery$elm_docstyle$Messages$checkToString = function (tajp) {
	var _p0 = tajp;
	switch (_p0.ctor) {
		case 'NoStartingSpace':
			return 'the first line of the comment does not start with a space';
		case 'NotCapitalized':
			return 'the first word of the comment is not capitalized';
		case 'NoStartingVerb':
			return A2(_elm_lang$core$Basics_ops['++'], 'the first line of the comment does not start ', 'with a verb in third person (stem -s)');
		case 'NoEndingPeriod':
			return 'the first line of the comment does not end with a period';
		case 'EmptyComment':
			return 'the comment does not contain any text';
		case 'WrongCommentType':
			return 'the comment syntax {-|...-} is not allowed here';
		case 'TodoComment':
			return 'the comment contains one of the words (todo, fixme)';
		case 'NoEntityComment':
			return 'expected a comment on top of the declaration, but found none';
		case 'NoTopLevelComment':
			return 'expected a top-level module comment, but found none';
		case 'NotExistingArgument':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'the argument (',
				A2(_elm_lang$core$Basics_ops['++'], _p0._0, ') does not exist'));
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'the argument (',
				A2(_elm_lang$core$Basics_ops['++'], _p0._0, ') does not appear in the documentation'));
	}
};
var _Parquery$elm_docstyle$Messages$entityTypeToString = function (entType) {
	var _p1 = entType;
	switch (_p1.ctor) {
		case 'Function':
			var _p3 = _p1._0;
			var paramsStr = function () {
				var _p2 = _p3;
				if (_p2.ctor === '[]') {
			...
			return A2(_elm_lang$core$Basics_ops['++'], 'function with ', paramsStr);
		case 'Record':
			var fieldsStr = A2(
				_elm_lang$core$Basics_ops['++'],
				'fields (',
				A2(
					_elm_lang$core$Basics_ops['++'],
					A2(_elm_lang$core$String$join, ', ', _p1._0),
					')'));
			return A2(_elm_lang$core$Basics_ops['++'], 'record with ', fieldsStr);
		case 'TypeDef':
...
var _Parquery$elm_docstyle$Messages$commentToString = F2(
	function (_p4, verbose) {
		var _p5 = _p4;
		var suffix = verbose ? A2(
			_elm_lang$core$Basics_ops['++'],
			', comment reading \"',
			A2(_elm_lang$core$Basics_ops['++'], _p5._1, '\"')) : '';
		var lStart = _elm_lang$core$Basics$toString(_p5._0.start.row + 1);
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'line ',
			A2(_elm_lang$core$Basics_ops['++'], lStart, suffix));
	});
var _Parquery$elm_docstyle$Messages$entityToString = F2(
	function (_p6, verbose) {
		var _p7 = _p6;
		var suffix = function () {
			if (verbose) {
				var _p8 = A2(_elm_lang$core$Maybe$map, _elm_lang$core$Tuple$second, _p7.comment);
				if (_p8.ctor === 'Just') {
					return A2(
						_elm_lang$core$Basics_ops['++'],
						' with comment \"',
					...
					return ' with no comment';
				}
			} else {
				return '';
			}
		}();
		var exposedStr = _p7.exposed ? 'exposed ' : '';
		var firstRow = _elm_lang$core$Basics$toString(_p7.range.start.row + 1);
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'line ',
			A2(
				...
				A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_Parquery$elm_docstyle$Messages$entityTypeToString(_p7.eType),
							A2(
								_elm_lang$core$Basics_ops['++'],
								' ',
								A2(
...
var _Parquery$elm_docstyle$Messages$issueToString = F2(
	function (verbose, issue) {
		var _p9 = _Parquery$elm_docstyle$Issue$unwrap(issue);
		var violated = _p9._0;
		var underlying = _p9._1;
		var violatedStr = function (s) {
			return A2(_elm_lang$core$Basics_ops['++'], s, '.');
		}(
			A2(
				_elm_lang$core$String$join,
				';\n',
				A2(_elm_lang$core$List$map, _Parquery$elm_docstyle$Messages$checkToString, violated)));
		var _p10 = underlying;
		switch (_p10.ctor) {
			case 'Entity':
				return A2(
					_elm_lang$core$Basics_ops['++'],
					A2(_Parquery$elm_docstyle$Messages$entityToString, _p10._0, verbose),
					A2(_elm_lang$core$Basics_ops['++'], ': ', violatedStr));
			case 'Dangling':
				return A2(
					_elm_lang$core$Basics_ops['++'],
					A2(_Parquery$elm_docstyle$Messages$commentToString, _p10._0, verbose),
					A2(_elm_lang$core$Basics_ops['++'], ': ', violatedStr));
			default:
				var _p11 = _p10._0;
				if (_p11.ctor === 'Just') {
					return A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							A2(_Parquery$elm_docstyle$Messages$commentToString, _p11._0, verbose),
							A2(_elm_lang$core$Basics_ops['++'], ': ', violatedStr)));
				} else {
					return A2(_elm_lang$core$Basics_ops['++'], 'line 2: ', violatedStr);
				}
		}
	});

var _Parquery$elm_docstyle$Encoders$encodeComment = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_1: {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'line',
					_1: _elm_lang$core$Json_Encode$int(_p1._0.start.row)
				},
				_1: {ctor: '[]'}
			}
		});
};
var _Parquery$elm_docstyle$Encoders$encodeEntity = function (entity) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'range',
				_1: _stil4m$elm_syntax$Elm_Syntax_Range$encode(entity.range)
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$string(
						_Parquery$elm_docstyle$Messages$entityTypeToString(entity.eType))
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'name',
						_1: _elm_lang$core$Json_Encode$string(entity.name)
					},
					_1: {
						ctor: '::',
						_0: {
							...
							_1: A2(
								...
								A2(_elm_lang$core$Maybe$map, _Parquery$elm_docstyle$Encoders$encodeComment, entity.comment))
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'exposed',
								_1: _elm_lang$core$Json_Encode$bool(entity.exposed)
							},
							_1: {ctor: '[]'}
						}
					}
...
var _Parquery$elm_docstyle$Encoders$encodeTrigger = function (trigger) {
	var _p2 = trigger;
	switch (_p2.ctor) {
		case 'Entity':
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'trigger_type',
						_1: _elm_lang$core$Json_Encode$string('entity')
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'entity',
							_1: _Parquery$elm_docstyle$Encoders$encodeEntity(_p2._0)
						},
						_1: {ctor: '[]'}
					}
				});
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'trigger_type',
						_1: _elm_lang$core$Json_Encode$string('dangling comment')
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'comment',
							_1: _Parquery$elm_docstyle$Encoders$encodeComment(_p2._0)
						},
						_1: {ctor: '[]'}
					}
				});
			...
			return _elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'trigger_type',
						_1: _elm_lang$core$Json_Encode$string('top-level comment')
					},
					_1: {
						ctor: '::',
						_0: {
							...
							_1: A2(
								_elm_lang$core$Maybe$withDefault,
								_elm_lang$core$Json_Encode$string(''),
								A2(_elm_lang$core$Maybe$map, _Parquery$elm_docstyle$Encoders$encodeComment, _p2._0))
						},
						_1: {ctor: '[]'}
					}
				});
...
var _Parquery$elm_docstyle$Encoders$encodeIssue = function (issue) {
	var _p3 = _Parquery$elm_docstyle$Issue$unwrap(issue);
	var violated = _p3._0;
	var trigger = _p3._1;
	var violationsStr = A2(_elm_lang$core$List$map, _Parquery$elm_docstyle$Messages$checkToString, violated);
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				...
				_1: _elm_lang$core$Json_Encode$list(
					A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, violationsStr))
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'trigger',
					_1: _Parquery$elm_docstyle$Encoders$encodeTrigger(trigger)
				},
				_1: {ctor: '[]'}
			}
		});
...
var _Parquery$elm_docstyle$Violations$filterIgnored = F2(
	function (toIgnore, checks) {
		var toKeep = function (check) {
			var _p0 = check;
			switch (_p0.ctor) {
				case 'NotExistingArgument':
					return !A2(
				...
				case 'NotAnnotatedArgument':
					return !A2(
						...
						toIgnore);
				default:
					return !A2(_elm_lang$core$List$member, check, toIgnore);
			}
		};
		return A2(_elm_lang$core$List$filter, toKeep, checks);
	});
var _Parquery$elm_docstyle$Violations$argumentRegex = _elm_lang$core$Regex$regex('- ´([a-zA-Z0-9]+)´ (--|&mdash;)');
var _Parquery$elm_docstyle$Violations$parseArguments = function (comment) {
	var matchToArgumentName = function (match) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			_elm_lang$core$List$head(
	...
	return A2(
		_elm_lang$core$List$map,
		matchToArgumentName,
		A3(_elm_lang$core$Regex$find, _elm_lang$core$Regex$All, _Parquery$elm_docstyle$Violations$argumentRegex, comment));
};
var _Parquery$elm_docstyle$Violations$topLevel = F2(
	function (maybeComment, ignored) {
		return A2(
			_Parquery$elm_docstyle$Violations$filterIgnored,
			ignored,
			function () {
				var _p1 = maybeComment;
				if (_p1.ctor === 'Just') {
					var _p2 = _p1._0._1;
					return A2(
						_elm_lang$core$List$filterMap,
						...
						{
							ctor: '::',
							_0: _Parquery$elm_docstyle$Check$startingSpace(_p2),
							_1: {
								ctor: '::',
								_0: _Parquery$elm_docstyle$Check$todoComment(_p2),
								_1: {
									ctor: '::',
									_0: _Parquery$elm_docstyle$Check$emptyComment(_p2),
									_1: {ctor: '[]'}
								}
							}
						});
					...
					return {
						ctor: '::',
						_0: _Parquery$elm_docstyle$Check$NoTopLevelComment,
						_1: {ctor: '[]'}
					};
				}
			}());
	});
var _Parquery$elm_docstyle$Violations$dangling = F2(
	function (_p3, ignored) {
		var _p4 = _p3;
		var _p5 = _p4._1;
		var commentLine = A2(_elm_lang$core$String$startsWith, '--', _p5) ? _p5 : A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			_elm_lang$core$List$head(
		...
		return A2(
			...
			A2(
				...
				{
					ctor: '::',
					_0: _Parquery$elm_docstyle$Check$startingCapitalized(commentLine),
					_1: {
						ctor: '::',
						_0: _Parquery$elm_docstyle$Check$startingSpace(commentLine),
						_1: {
							ctor: '::',
							_0: _Parquery$elm_docstyle$Check$endingPeriod(commentLine),
							_1: {
								ctor: '::',
								_0: _Parquery$elm_docstyle$Check$commentType(commentLine),
								_1: {
									ctor: '::',
									_0: _Parquery$elm_docstyle$Check$todoComment(commentLine),
									_1: {
										ctor: '::',
										_0: _Parquery$elm_docstyle$Check$emptyComment(_p5),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _Parquery$elm_docstyle$Violations$entity = F3(
	function (entity, checkAllDefinitions, ignored) {
		return (!(entity.exposed || checkAllDefinitions)) ? {ctor: '[]'} : A2(
			_Parquery$elm_docstyle$Violations$filterIgnored,
			ignored,
			function () {
				var _p6 = entity.comment;
				if (_p6.ctor === 'Just') {
					var _p10 = _p6._0._1;
					var _p7 = entity.eType;
					switch (_p7.ctor) {
						case 'Function':
							var _p8 = _p7._0;
							var commentArgs = _Parquery$elm_docstyle$Violations$parseArguments(_p10);
							var notAnnotatedArgsCheck = A2(
								_elm_lang$core$List$filterMap,
								_elm_lang$core$Basics$identity,
								A2(
									_elm_lang$core$List$map,
									_Parquery$elm_docstyle$Check$notAnnotatedArgument(commentArgs),
									_p8));
							var notExistingArgsCheck = A2(_Parquery$elm_docstyle$Check$notExistingArgument, commentArgs, _p8);
							var firstLine = _elm_lang$core$List$head(
								A2(_elm_lang$core$String$split, '\n', _p10));
							return A2(
								_elm_lang$core$List$append,
								...
								A2(
									...
									A2(
										...
										A2(
											...
											{
												ctor: '::',
												_0: _Parquery$elm_docstyle$Check$todoComment(_p10),
												_1: {
													ctor: '::',
													_0: _Parquery$elm_docstyle$Check$emptyComment(_p10),
													_1: {ctor: '[]'}
												}
											},
											A2(
												...
												A2(
													...
													function (line) {
														return {
															ctor: '::',
															_0: _Parquery$elm_docstyle$Check$startingCapitalized(line),
															_1: {
																ctor: '::',
																_0: _Parquery$elm_docstyle$Check$startingVerb(line),
																_1: {
																	ctor: '::',
																	_0: _Parquery$elm_docstyle$Check$startingSpace(line),
																	_1: {
																		ctor: '::',
																		_0: _Parquery$elm_docstyle$Check$endingPeriod(line),
																		_1: {ctor: '[]'}
																	}
																}
															}
						...
						case 'Record':
							...
							var notAnnotatedArgsCheck = A2(
								...
								A2(
									...
									_Parquery$elm_docstyle$Check$notAnnotatedArgument(commentArgs),
									_p9));
							var notExistingArgsCheck = A2(_Parquery$elm_docstyle$Check$notExistingArgument, commentArgs, _p9);
							var firstLine = _elm_lang$core$List$head(
								A2(_elm_lang$core$String$split, '\n', _p10));
							return A2(
								_elm_lang$core$List$append,
														...
														return {
															...
															_1: {
																...
																_1: {
																	...
																	_1: {
																		ctor: '::',
																		_0: _Parquery$elm_docstyle$Check$emptyComment(line),
																		_1: {
																			ctor: '::',
																			_0: _Parquery$elm_docstyle$Check$endingPeriod(line),
																			_1: {ctor: '[]'}
					...
					switch (_p11.ctor) {
						case 'Function':
							return A2(
								...
								_Parquery$elm_docstyle$Check$NoEntityComment,
								A2(_elm_lang$core$List$map, _Parquery$elm_docstyle$Check$NotAnnotatedArgument, _p11._0));
						case 'Record':
							return A2(
								F2(
									function (x, y) {
						...
						default:
							return {
								ctor: '::',
								_0: _Parquery$elm_docstyle$Check$NoEntityComment,
								_1: {ctor: '[]'}
							};
					}
				}
...
var _Parquery$elm_docstyle$Checker$getIssues = F2(
	function (parsed, config) {
		var topLevelLine = A2(
			...
			A2(
				...
				function (_p0) {
					var _p1 = _p0;
					return _p1._0.start.row;
				},
				parsed.topLevelComment));
		var checkAll = config.checkAllDefinitions;
		var ignoredChecks = config.excludedChecks;
		var topLevelCommentIssues = function (issue) {
			return {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: topLevelLine, _1: issue},
				_1: {ctor: '[]'}
			};
		}(
			function (violated) {
				return A2(
					_Parquery$elm_docstyle$Issue$fromViolationsAndTrigger,
					violated,
					_Parquery$elm_docstyle$Issue$TopLevel(parsed.topLevelComment));
			}(
				A2(_Parquery$elm_docstyle$Violations$topLevel, parsed.topLevelComment, ignoredChecks)));
		var otherCommentsIssues = A2(
			_elm_lang$core$List$map,
			function (_p2) {
				var _p3 = _p2;
				return {ctor: '_Tuple2', _0: _p3._0._0.start.row, _1: _p3._1};
			},
			A2(
				_elm_lang$core$List$map,
				function (_p4) {
					...
					return {
						...
						_1: A2(
							_Parquery$elm_docstyle$Issue$fromViolationsAndTrigger,
							_p5._1,
							_Parquery$elm_docstyle$Issue$Dangling(_p6))
					};
				},
				A2(
					_elm_lang$core$List$map,
					function (comment) {
						return {
							ctor: '_Tuple2',
							_0: comment,
							_1: A2(_Parquery$elm_docstyle$Violations$dangling, comment, ignoredChecks)
						};
					},
		...
		var entityIssues = A2(
			...
			function (_p7) {
				...
				return {
					ctor: '_Tuple2',
					_0: _p9.range.start.row,
					_1: A2(
						_Parquery$elm_docstyle$Issue$fromViolationsAndTrigger,
						_p8._1,
						_Parquery$elm_docstyle$Issue$Entity(_p9))
				};
			},
			A2(
				_elm_lang$core$List$map,
				function (ent) {
					return {
						ctor: '_Tuple2',
						_0: ent,
						_1: A3(_Parquery$elm_docstyle$Violations$entity, ent, checkAll, ignoredChecks)
					};
				},
				parsed.entities));
		return A2(
			...
			A2(
				...
				A2(
					...
					_elm_lang$core$List$concat(
						{
							ctor: '::',
							_0: topLevelCommentIssues,
							_1: {
								ctor: '::',
								_0: otherCommentsIssues,
								_1: {
									ctor: '::',
									_0: entityIssues,
									_1: {ctor: '[]'}
...
var _Parquery$elm_docstyle$Checker$getIssuesString = F2(
	function (parsed, config) {
		return A2(
			_elm_lang$core$String$join,
			'\n',
			A2(
				...
				A2(
					_elm_lang$core$List$map,
					_Parquery$elm_docstyle$Messages$issueToString(config.verbose),
					A2(_Parquery$elm_docstyle$Checker$getIssues, parsed, config))));
	});
var _Parquery$elm_docstyle$Checker$getIssuesJSON = F2(
	function (parsed, config) {
		return function (issues) {
			return _elm_lang$core$Json_Encode$list(
				A2(_elm_lang$core$List$map, _Parquery$elm_docstyle$Encoders$encodeIssue, issues));
		}(
			A2(_Parquery$elm_docstyle$Checker$getIssues, parsed, config));
	});
...
var _Parquery$elm_docstyle$Intermediate$getCommentForType = F2(
	function (entity, comments) {
		var foundComment = A2(
			_elm_lang$core$Dict$get,
			entity.range.start.row - 1,
			_elm_lang$core$Dict$fromList(
				A2(
					_elm_lang$core$List$map,
					function (_p0) {
						...
						return {
							ctor: '_Tuple2',
							_0: _p2.end.row,
							_1: {ctor: '_Tuple2', _0: _p2, _1: _p1._1}
						};
					},
					comments)));
...
var _Parquery$elm_docstyle$Intermediate$getTopLevelComment = function (file) {
	var firstComment = _elm_lang$core$List$head(
		A2(
			_elm_lang$core$List$sortBy,
			function (_p3) {
				var _p4 = _p3;
				return _p4._0.start.row;
			},
			file.comments));
	var rowFirstDeclaration = _elm_lang$core$List$minimum(
		A2(
			_elm_lang$core$List$map,
			function (_p5) {
				var _p6 = _p5;
				return _p6._0.start.row;
			},
			file.declarations));
	var rowFirstImport = _elm_lang$core$List$minimum(
		A2(
			_elm_lang$core$List$map,
			function (imp) {
				return imp.range.start.row;
			},
			file.imports));
	var isTopLevel = function (_p7) {
		var _p8 = _p7;
		var firstRow = function () {
			var _p9 = rowFirstImport;
			if (_p9.ctor === 'Just') {
				...
				return A2(
					_elm_lang$core$Maybe$withDefault,
					1 / 0,
					A2(_elm_lang$core$Maybe$map, _elm_lang$core$Basics$toFloat, rowFirstDeclaration));
			}
		}();
		return A2(_elm_lang$core$String$startsWith, '{-|', _p8._1) && (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$toFloat(_p8._0.start.row),
			firstRow) < 0);
	};
	return A2(
		_elm_lang$core$Maybe$andThen,
		function (rangedComment) {
			return isTopLevel(rangedComment) ? _elm_lang$core$Maybe$Just(rangedComment) : _elm_lang$core$Maybe$Nothing;
		},
		firstComment);
};
var _Parquery$elm_docstyle$Intermediate$getVarNamesFromPattern = function (pattern) {
	var recurseFurther = F2(
	...
	var deduceNames = F2(
		function (patt, names) {
			...
			switch (_p12.ctor) {
				case 'VarPattern':
					return {ctor: '::', _0: _p12._0, _1: names};
				case 'TuplePattern':
					return A2(recurseFurther, _p12._0, names);
				case 'ListPattern':
					return A2(recurseFurther, _p12._0, names);
				case 'RecordPattern':
					return A2(
				...
				case 'ParenthesizedPattern':
					return A2(
						...
						names);
				case 'NamedPattern':
					return A2(recurseFurther, _p12._1, names);
				case 'AsPattern':
					return A2(
						recurseFurther,
						{
	...
	return A2(
		_elm_lang$core$List$filter,
		function (s) {
			return !_elm_lang$core$Native_Utils.eq(s, '_');
		},
		A2(
			deduceNames,
			pattern,
...
var _Parquery$elm_docstyle$Intermediate$declarationToEntity = F2(
	function (_p13, exposedFn) {
		var _p14 = _p13;
		var entity = {range: _p14._0, eType: _Parquery$elm_docstyle$Models$TypeDef, name: '', comment: _elm_lang$core$Maybe$Nothing, exposed: false};
		var _p15 = _p14._1;
		switch (_p15.ctor) {
			case 'FuncDecl':
				var _p16 = _p15._0;
				var comment = A2(
					_elm_lang$core$Maybe$map,
					function (docum) {
						return {ctor: '_Tuple2', _0: docum.range, _1: docum.text};
					},
					_p16.documentation);
				var nm = _p16.declaration.name.value;
				var paramNames = _elm_lang$core$List$concat(
					A2(
						_elm_lang$core$List$map,
						_Parquery$elm_docstyle$Intermediate$getVarNamesFromPattern,
						A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$second, _p16.declaration.$arguments)));
				var tp = _Parquery$elm_docstyle$Models$Function(paramNames);
				return _elm_lang$core$Maybe$Just(
			...
			case 'AliasDecl':
				...
				var comment = A2(
					...
					_p18.documentation);
				var nm = _p18.name;
				var _p17 = _elm_lang$core$Tuple$second(_p18.typeAnnotation);
				if (_p17.ctor === 'Record') {
					var fields = A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$first, _p17._0);
					var tp = _Parquery$elm_docstyle$Models$Record(fields);
					return _elm_lang$core$Maybe$Just(
						_elm_lang$core$Native_Utils.update(
							entity,
							{
					...
					var nm = _p18.name;
					var tp = _Parquery$elm_docstyle$Models$TypeAlias;
					return _elm_lang$core$Maybe$Just(
						_elm_lang$core$Native_Utils.update(
							entity,
							{
			...
			case 'TypeDecl':
				var nm = _p15._0.name;
				var tp = _Parquery$elm_docstyle$Models$TypeDef;
				return _elm_lang$core$Maybe$Just(
					_elm_lang$core$Native_Utils.update(
						entity,
						{
...
var _Parquery$elm_docstyle$Intermediate$isExposed = F2(
	function (mod, entityName) {
		var _p19 = _stil4m$elm_syntax$Elm_Syntax_Module$exposingList(mod);
		if (_p19.ctor === 'All') {
			return true;
		} else {
			return A2(
				...
				function (x) {
					...
					switch (_p20.ctor) {
						case 'FunctionExpose':
							return _elm_lang$core$Native_Utils.eq(_p20._0, entityName);
						case 'InfixExpose':
							return _elm_lang$core$Native_Utils.eq(_p20._0, entityName);
						case 'TypeOrAliasExpose':
							return _elm_lang$core$Native_Utils.eq(_p20._0, entityName);
						default:
							return _elm_lang$core$Native_Utils.eq(_p20._0.name, entityName);
					}
				},
				A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$second, _p19._0));
		}
	});
var _Parquery$elm_docstyle$Intermediate$translate = function (_p21) {
	var _p22 = _p21;
	var _p28 = _p22.moduleDefinition;
	var topLevelComment = _Parquery$elm_docstyle$Intermediate$getTopLevelComment(_p22);
	var sortedComments = A2(
		_elm_lang$core$List$sortBy,
		function (_p23) {
			var _p24 = _p23;
			return _p24._0.start.row;
		},
		_p22.comments);
	var entities = A2(
		_elm_lang$core$List$map,
		function (ent) {
			return _elm_lang$core$Native_Utils.eq(ent.eType, _Parquery$elm_docstyle$Models$TypeDef) ? A2(_Parquery$elm_docstyle$Intermediate$getCommentForType, ent, sortedComments) : ent;
		},
		A2(
			_elm_lang$core$List$filterMap,
			_elm_lang$core$Basics$identity,
			A2(
				...
				function (dec) {
					return A2(
						_Parquery$elm_docstyle$Intermediate$declarationToEntity,
						dec,
						_Parquery$elm_docstyle$Intermediate$isExposed(_p28));
				},
				A2(
					_elm_lang$core$List$sortBy,
					function (_p25) {
						var _p26 = _p25;
						return _p26._0.start.row;
					},
					_p22.declarations))));
	var otherComments = function (list) {
		return A2(
			_elm_lang$core$List$filter,
			function (com) {
				return !A2(
					_elm_lang$core$List$member,
					_elm_lang$core$Maybe$Just(com),
					A2(
						_elm_lang$core$List$map,
						function (_) {
							return _.comment;
			...
			A2(
				...
				A2(
					_elm_lang$core$Maybe$map,
					function (_p27) {
						return A2(_elm_lang$core$List$drop, 1, list);
					},
					topLevelComment)));
	}(sortedComments);
	var moduleName = A2(
		...
		A2(
			_elm_lang$core$Maybe$map,
			_elm_lang$core$String$join('.'),
			_stil4m$elm_syntax$Elm_Syntax_Module$moduleName(_p28)));
	return {moduleName: moduleName, entities: entities, topLevelComment: topLevelComment, otherComments: otherComments};
};
...
var _Parquery$elm_docstyle$Main$outgoing = _elm_lang$core$Native_Platform.outgoingPort(
	'outgoing',
	function (v) {
		return v;
	});
var _Parquery$elm_docstyle$Main$toPort = function (val) {
	return _Parquery$elm_docstyle$Main$outgoing(val);
};
var _Parquery$elm_docstyle$Main$init = function (flags) {
	var _p0 = _Parquery$elm_docstyle$Configuration$fromFlags(flags);
	if (_p0.ctor === 'Ok') {
		return {
			ctor: '_Tuple2',
			_0: {humanReadableResult: '', config: _p0._0},
			_1: _Parquery$elm_docstyle$Main$toPort(
				_elm_lang$core$Json_Encode$string(''))
		};
	} else {
		var _p1 = _p0._0;
		return {
			ctor: '_Tuple2',
			_0: {humanReadableResult: _p1, config: _Parquery$elm_docstyle$Configuration$defaultModel},
			_1: _Parquery$elm_docstyle$Main$toPort(
				_elm_lang$core$Json_Encode$string(_p1))
		};
	}
};
var _Parquery$elm_docstyle$Main$update = F2(
	function (msg, model) {
		var _p2 = msg;
		if (_p2.ctor === 'Process') {
			var _p3 = _stil4m$elm_syntax$Elm_Parser$parse(_p2._0);
			if (_p3.ctor === 'Ok') {
				var file = A2(_stil4m$elm_syntax$Elm_Processing$process, _stil4m$elm_syntax$Elm_Processing$init, _p3._0);
				var innerRepr = _Parquery$elm_docstyle$Intermediate$translate(file);
				var issues = _elm_lang$core$Native_Utils.eq(model.config.format, _Parquery$elm_docstyle$Configuration$HUMAN) ? _elm_lang$core$Json_Encode$string(
					A2(_Parquery$elm_docstyle$Checker$getIssuesString, innerRepr, model.config)) : A2(_Parquery$elm_docstyle$Checker$getIssuesJSON, innerRepr, model.config);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							humanReadableResult: _elm_lang$core$Basics$toString(issues)
						}),
					_1: _Parquery$elm_docstyle$Main$toPort(issues)
				};
			} else {
				var _p4 = _p3._0;
				return {
...
var _Parquery$elm_docstyle$Main$incoming = _elm_lang$core$Native_Platform.incomingPort('incoming', _elm_lang$core$Json_Decode$value);
var _Parquery$elm_docstyle$Main$Model = F2(
	function (a, b) {
		return {humanReadableResult: a, config: b};
	});
var _Parquery$elm_docstyle$Main$NoOp = {ctor: 'NoOp'};
var _Parquery$elm_docstyle$Main$Process = function (a) {
	return {ctor: 'Process', _0: a};
};
var _Parquery$elm_docstyle$Main$msgDecode = function (val) {
	return A2(
		_elm_lang$core$Result$withDefault,
		_Parquery$elm_docstyle$Main$NoOp,
		A2(
			_elm_lang$core$Result$map,
			_Parquery$elm_docstyle$Main$Process,
			A2(_elm_lang$core$Json_Decode$decodeValue, _elm_lang$core$Json_Decode$string, val)));
};
var _Parquery$elm_docstyle$Main$subscriptions = function (_p5) {
	return _Parquery$elm_docstyle$Main$incoming(_Parquery$elm_docstyle$Main$msgDecode);
};
var _Parquery$elm_docstyle$Main$main = _elm_lang$core$Platform$programWithFlags(
	{init: _Parquery$elm_docstyle$Main$init, update: _Parquery$elm_docstyle$Main$update, subscriptions: _Parquery$elm_docstyle$Main$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (checkAllDefinitions) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
					...
					return A2(
						...
						function (format) {
							return A2(
								...
								function (verbose) {
									return _elm_lang$core$Json_Decode$succeed(
										{checkAllDefinitions: checkAllDefinitions, excludedChecks: excludedChecks, format: format, verbose: verbose});
								},
		...
		A2(_elm_lang$core$Json_Decode$field, 'checkAllDefinitions', _elm_lang$core$Json_Decode$bool)));

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _Parquery$elm_docstyle$Main$main !== 'undefined') {
    _Parquery$elm_docstyle$Main$main(Elm['Main'], 'Main', undefined);
}
